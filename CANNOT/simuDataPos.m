function [eRib,etib,pij,pattern,cRe_truth,cte_truth,bRp_truth,btp_truth]=simuDataPos(n,mx,my,sigma_t,sigma_R,sigma_pos)
...
for i=1:n
    ...
    for j=1:m
        pij(:,i,j)= homo(cTe*eTb*bTp*[pattern(:,j);1])+normrnd(0,sigma_pos,[3 1]);   
    end
